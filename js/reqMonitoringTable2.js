function createRiskMetricsCells() {
    ...
    var rows = document.querySelectorAll('#req-monitoring-content2 table tr');
...
function copyERValues() {
    ...
    var rows1 = document.querySelectorAll('#req-monitoring-content1 table tr');
    
    // Отримати всі рядки в межах div з id req-analis-content2
    var rows2 = document.querySelectorAll('#req-monitoring-content2 table tr');
...
function findMinVRER() {
    ...
    var vrerCells = document.querySelectorAll('#req-monitoring-content2 table td:nth-child(5)');
    ...
    document.getElementById('min-evrer').textContent = minVRER.toFixed(2);
}
...
function findMaxVRER() {
    ...
    document.getElementById('max-evrer').textContent = maxVRER.toFixed(2);
}

function setPriorityIntervals() {
    minVRER = parseFloat(document.getElementById('min-evrer').textContent);
    maxVRER = parseFloat(document.getElementById('max-evrer').textContent);
    ...
    document.getElementById('low-priority1').textContent = "[" + interval1[0].toFixed(2) + ";" + interval1[1].toFixed(2) + "]";
    document.getElementById('middle-priority1').textContent = "[" + interval2[0].toFixed(2) + ";" + interval2[1].toFixed(2) + "]";
    document.getElementById('high-priority1').textContent = "[" + interval3[0].toFixed(2) + ";" + interval3[1].toFixed(2) + "]";
}
...
function setPriorityValues() {
    // Отримати всі рядки в межах div з id req-analis-content2
    var rows = document.querySelectorAll('#req-monitoring-content2 table tr');
    var minVRER = parseFloat(document.getElementById('min-evrer').textContent);
    var maxVRER = parseFloat(document.getElementById('max-evrer').textContent);
